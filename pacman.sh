...
PACKAGES=("nautilus" "git" "python3" "ttf-ubuntu-font-family" "gnome-shell-extensions" "gnome-text-editor" "gnome-tweaks" "gnome-shell-extension-desktop-icons-ng" "gnome-shell-extension-arc-menu" "gnome-shell-extension-dash-to-panel" "zsh" "powerline" "powerline-fonts")
for ARG in "$@"; do
  case $ARG in
    --no-update)
      DO_UPDATE=false
